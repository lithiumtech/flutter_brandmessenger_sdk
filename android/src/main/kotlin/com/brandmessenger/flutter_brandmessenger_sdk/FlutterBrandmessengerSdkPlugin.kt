...
class FlutterBrandmessengerSdkPlugin: FlutterPlugin, MethodCallHandler, ActivityAware {
  ...
  override fun onMethodCall(@NonNull call: MethodCall, @NonNull result: Result) {
    ...
    if (call.method == "dismiss") {
      ...
      BrandMessengerManager.getAllDisplayConditions(activity!!, object: KBMGenericCallback<Array<KBMWidget.DisplayCondition>, java.lang.Exception> {
      ...
      if (companyKey != null) {
        BrandMessengerManager.init(activity!!, companyKey, applicationId, widgetId, object: KBMCallback {
        ...
        result.error("InitError", "Initialization required company key", "Initialization required company key")
      }
    } else if (call.method == "isAllDisplayConditionsMet") {
      BrandMessengerManager.isAllDisplayConditionsMet(activity!!, object : KBMGenericCallback<Boolean, java.lang.Exception> {
      ...
      BrandMessengerManager.isDeviceGeoIPAllowed(activity!!, object : KBMGenericCallback<Boolean, java.lang.Exception> {
        override fun onSuccess(p0: Boolean?) {
          result.success(p0)
        }
      ...
      BrandMessengerManager.isWidgetHashEnabled(activity!!, object : KBMGenericCallback<Boolean, java.lang.Exception> {
        override fun onSuccess(p0: Boolean?) {
          result.success(p0)
        }
      ...
      BrandMessengerUserPreference.getInstance(activity).setUsePersistentMessagesStorage( arg ?: false)
      ...
      BrandMessengerManager.shouldThrottle(activity!!, object : KBMGenericCallback<Boolean, java.lang.Exception> {
        override fun onSuccess(p0: Boolean?) {
          result.success(p0)
        }
      ...
      BrandMessengerManager.show(activity, object : KBMGenericCallback<Boolean, java.lang.Exception> {
        override fun onSuccess(p0: Boolean?) {
          result.success(p0)
        }
      ...
      BrandMessengerManager.showWithWelcome(activity, object : KBMGenericCallback<Boolean, java.lang.Exception> {
        override fun onSuccess(p0: Boolean?) {
          result.success(p0)
        }
